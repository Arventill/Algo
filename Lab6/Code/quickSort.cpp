...
#define SIZE 30
using namespace std;
void quick_sort(vector<int>& numbers_vector, const int left_pivot, const int
	right_pivot) {
...
int main()
{
	...
	//Code to check how algorithm handles with same values
	//numbers_vector.push_back(numbers_vector[0]);
	sort(numbers_vector);
